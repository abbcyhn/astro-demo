...
import ReactTipCallout from '../../components/ReactTipCallout.jsx';
...
<ReactTipCallout 
  title="Want to get quick feedback on your answer?"
  client:load
>
  **Before you read my answer**, let's see how you'd handle this tricky question right now. 
  
  Choose your instinctive response below — you might be surprised by what most people get wrong!
