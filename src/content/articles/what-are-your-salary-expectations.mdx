...
{/* TODO: Create a game for saying a number. Example <SalarySliderGame client:load />  */}
...
{/* TODO: Create a game for saying a range. Example <SalarySliderGame client:load />  */}
...
I once typed “Negotiable.” Still got the interview.

Another time? I wrote “Monthly or yearly?” Still got the offer.

They might smile at your answer or not.

But it shows you’re thoughtful. And that you want more info first.
...
👉 Subscribe to my newsletter to get more tips like this.
